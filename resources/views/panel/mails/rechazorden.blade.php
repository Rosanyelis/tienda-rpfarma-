                            ...
                            <tr>
                                <td
                                    ...
                                    <img style="width: 100px !important;"
                                        src="{{asset('images/email/kyc-pending.pn')}}" alt="Pending">
                                </td>
                            </tr>
                            <tr>
                                <td
                                    ...
                                    <h4 style="color: #f4bd0e !important; margin-bottom: 1rem !important;">Tu Compra fué Rechazada</h4>
                                    <p>Estimado cliente <b>{{ $orden->cliente->nombre }}
                                            {{ $orden->cliente->apellido }}</b>.<br>
                                        El motivo del rechazo de su compra se debe: {{ $orden->motivo_rechazo }}.<br>
                                        Por favor, intente nuevamente cumpliendo con los parámetros de la compra.
                                    </p>

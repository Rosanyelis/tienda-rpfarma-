        ...
        <tbody>
            <tr>
                <td style="padding-top: 2.75rem !important;">
                    ...
                    <table
                        style="width: 96%; max-width: 620px; margin: 0 auto; background: #ffffff;">
                        <tbody>
                            <tr>
                                <td
                                    ...
                                    <h4>Reclamo Nro:</h4> {{ $reclamo->codigo }}
                                    <p style="text-align: justify; ">
                                        Estimado cliente <b>{{ $reclamo->user->cliente->nombre }} {{ $reclamo->user->cliente->apellido }}</b>, <br>
                                        {{ $respuesta->mensaje }}
                                    </p>
                                </td>
                            </tr>

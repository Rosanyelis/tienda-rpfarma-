        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Laboratorios</h3>
                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li class="nk-block-tools-opt">
                                    <a href="{{ url('admin/configuraciones/laboratorio/crear-laboratorio') }}" class="btn btn-primary">
        ...
        <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
            <thead>
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col tb-col-sm"><span>LABORATORIO</span></th>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <ul class="link-list-opt no-bdr">
                                            <li>
                                                <a href="{{ url('admin/configuraciones/laboratorio/'.$item->id.'/editar-laboratorio') }}" >
    ...
    <script>
        (function(NioApp, $){
            ...
            $('.datatable-init tbody').on('click', '.delete-record', function(){
                ...
                let baseUrl = '{{ url('admin/configuraciones/laboratorio') }}/' + dataid +

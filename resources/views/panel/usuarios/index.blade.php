                            ...
                            <div class="toggle-expand-content" data-content="pageMenu">
                                <ul class="nk-block-tools g-3">
                                    <li class="nk-block-tools-opt">
                                        <a href="{{ url('admin/configuraciones/usuarios/crear-usuario') }}" class="btn btn-primary">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <ul class="link-list-opt no-bdr">
                                                <li><a href="{{ url('admin/configuraciones/usuarios/'.$item->id.'/editar-usuario') }}"><em class="icon ni ni-edit"></em><span>Editar Usuario</span></a></li>
                                                <li><a href="#"><em class="icon ni ni-eye"></em><span>Ver Usuario</span></a></li>
                                                <li><a href="#"><em class="icon ni ni-trash"></em><span>Desactivar Usuario</span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>

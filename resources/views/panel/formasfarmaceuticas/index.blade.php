        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Formas Farmaceuticas</h3>
                        ...
                        <div class="toggle-expand-content" data-content="pageMenu">
                            <ul class="nk-block-tools g-3">
                                <li class="nk-block-tools-opt">
                                    <a href="{{ url('admin/configuraciones/formas-farmaceuticas/crear-formas-farmaceuticas') }}" class="btn btn-primary">
                                        <em class="icon ni ni-plus-medi-fill"></em>
                                        <span>Crear Formas Farmaceuticas</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
        ...
        <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
            <thead>
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col tb-col-sm"><span>FORMAS FARMACEUTICAS</span></th>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <ul class="link-list-opt no-bdr">
                                            <li>
                                                <a href="{{ url('admin/configuraciones/formas-farmaceuticas/'.$item->id.'/editar-formas-farmaceuticas') }}" >
    ...
    <script>
        (function(NioApp, $){
            ...
            $('.datatable-init tbody').on('click', '.delete-record', function(){
                ...
                let baseUrl = '{{ url('admin/configuraciones/formas-farmaceuticas') }}/' + dataid +
                    '/eliminar-formas-farmaceuticas';
                Swal.fire({

            ...
            <div class="nk-block-head nk-block-head-sm">
                <div class="nk-block-between">
                    <div class="nk-block-head-content">
                        <h3 class="nk-block-title page-title">Reclamos, Opiniones y Sugerencias</h3>
            ...
            <table class="datatable-init nowrap nk-tb-list is-separate" data-auto-responsive="false">
                <thead>
                    <tr class="nk-tb-item nk-tb-head">
                        ...
                        <th class="nk-tb-col tb-col-sm"><span>TIPO</span></th>
                        <th class="nk-tb-col tb-col-sm"><span>FECHA PUBLICADO</span></th>
                ...
                <tbody>
                    ...
                    <tr class="nk-tb-item">
                        ...
                        <td class="nk-tb-col tb-col-sm">
                            <span class="title">{{ $item->tipo }}</span>
                        </td>
                        <td class="nk-tb-col tb-col-sm">
                            <span class="tb-product">
                                <span class="title">{{ \Carbon\Carbon::parse($item->created_at)->translatedFormat('d F, Y h:i A')  }}</span>
                            </span>
                        </td>
                        <td class="nk-tb-col tb-col-sm">
                            @if ($item->estatus == 'Abierto')

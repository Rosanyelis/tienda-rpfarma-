...
<head>
    ...
    <!-- Page Title  -->
    <title>Dashboard | Panel Administrativo RPFARMA</title>
    <!-- StyleSheets  -->
                                        ...
                                        <a href="#" class="dropdown-toggle mr-n1" data-toggle="dropdown">
                                            <div class="user-toggle">
                                                ...
                                                <div class="user-info d-none d-xl-block">
                                                    ...
                                                    <div class="user-status user-status-verified">{{ Auth::user()->rol->name }}</div>
                                                </div>
                                            </div>
                                        </a>
                ...
                <div class="nk-footer">
                    <div class="container-fluid">
                        <div class="nk-footer-wrap">
                            <div class="nk-footer-copyright"> &copy; Tienda RPFARMA. Todos los Derechos Reservados.
                            </div>
                        </div>
                    </div>
                </div>
